...
function ask_gpt($prompt, $openai_key) {
    $data = [
        "model" => "gpt-4o",
        "messages" => [
            ["role" => "system", "content" => "Ты ассистент Сергея Корнаухова, брокера по недвижимости в Батуми. Общайся дружелюбно и по делу. Выясняй, что нужно клиенту (жить, сдавать, вид, площадь, бюджет и т.д.), и предлагай только из базы, которую дам."],
...
if (isset($update["message"])) {
    ...
    $full_prompt = $base_prompt . "\nПользователь пишет: " . $text . "\nОтветь как консультант: сначала уточни его запрос, потом предлагай варианты, если он всё уже указал.";
